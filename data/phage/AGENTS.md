...
- The 2.4e-12 m^2/s dead-K-12 agarose value includes adsorption effects in the apparent transport measurement; it is evidence/caution, not Petra's living-host diffusion coefficient. The v2 transport record must keep living-host physical transport explicitly `out-of-domain` with source keys explaining why adsorption/proliferation-confounded apparent transport is not a passive scalar diffusion calibration.
