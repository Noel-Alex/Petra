...
/**
 * Keep global keyboard shortcuts inside the same runtime-availability envelope
 * as the visible controls. In particular, a shortcut must not arm playback or
 * change speed while the corresponding button is disabled.
 */
