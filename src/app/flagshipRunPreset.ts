...
/**
 * Resolve repository-owned startup state against repository-owned flagship
 * mechanism authority. The run preset may choose deterministic engineering
 * state; it cannot relabel the scenario or parameter set it initializes.
 */
