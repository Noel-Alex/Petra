...
- Exact sweep identity must eventually include deterministic execution horizon/cadence. Until #685 lands, do not treat out-of-band `totalTicks` / `snapshotEveryTicks` changes as resume-compatible merely because the existing plan digest matches.
