...
- React may request a whole-dish overview through the existing renderer `resetCamera()` controller. Keep that bridge declarative and thin; do not duplicate camera state or zoom policy in React.
