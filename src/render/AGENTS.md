...
- React may request an overview reset through the existing renderer `resetCamera()` controller. Keep that bridge declarative/thin; do not duplicate camera state in React.
