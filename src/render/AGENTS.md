...
- The visible dish aperture has one presentation geometry authority in `src/render/pixi/camera.ts`: drawing, screen↔dish conversion, pan scale, wheel/pinch/double-click anchors, clipping, and selection adapters must consume the same center/diameter contract rather than repeating viewport-square assumptions or the aperture fraction.
