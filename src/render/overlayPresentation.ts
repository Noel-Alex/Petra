...
const REGISTRY = {
  ...
  "division-rate": sequential(
    ...
    0.21,
    0.02,
    "Low → high interval-average division biomass rate (pre-spread)",
  ),
  "death-rate": sequential(
    "death-rate",
    0x5d8cff,
    "#5d8cff",
    "diagonal-back",
    ...
    0.21,
    0.02,
    "Low → high interval-average death biomass rate (pre-spread)",
  ),
  lineage: sequential(
    "lineage",
    0x58c6d8,
