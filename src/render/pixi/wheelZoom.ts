...
/**
 * Presentation-only wheel-input policy. Actual device feel remains a #59
 * browser/hardware acceptance concern rather than a scientific parameter.
 */
...
export function normalizeWheelDeltaY(
  ...
  validateWheelZoomPolicy(policy);
...
export function validateWheelZoomPolicy(policy: WheelZoomPolicy): void {
