...
/**
 * Serializable authoritative composed-state checkpoint.
 *
 * The composed state carries ordered lineage + genotype channel identity from
 * the simulation core. Worker/UI layers may copy it, but may not reconstruct or
 * relabel genotype identity from presentation data.
 */
...
export type WorkerRequest =
  | {
      ...
      identity: RunIdentity
      /**
       * Explicit composed-authority capability. Omission retains only the
       * synthetic infrastructure fixture; callers must not invent a config.
       */
