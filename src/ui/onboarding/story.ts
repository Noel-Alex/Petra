...
export function resolveOnboardingPresentation(
  ...
  return {
    ...
    easing: token.easing,
    ambient: {
      primaryDrift: resolveDecorativeLoop("onboardingAmbientPrimary", preference),
      secondaryDrift: resolveDecorativeLoop("onboardingAmbientSecondary", preference),
      focusOrbit: resolveDecorativeLoop("onboardingFocusOrbit", preference),
    },
